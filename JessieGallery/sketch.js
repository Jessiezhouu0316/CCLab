...
let options1 = {manHands: 2, flipped: true};
let options2 = { maxFaces: 1, refineLandmarks: false, flipped: true };
...
function draw() {
  ...
  restriction = constrain(100 * sin(t), -20, 20);
  world = map(restriction, -20, 20, 0, 255);
  background(world);
  for (let i = 0; i < faces.length; i++) {

    let face = faces[i];
    let p1 = face.keypoints[4];
    fill(255-world,40);
    noStroke();
    ellipse(p1.x, p1.y+height/3, 200,600);
  }
